...
def build_blender_tools() -> list[Tool]:
    return [
        Tool(
            ...
            description="Crea un script Python de Blender para generar un modelo 3D inicial.",
            parameters={"prompt": "Descripción del modelo 3D", "script_name": "Nombre opcional del script"},
            handler=create_blender_script,
        ),
        Tool(
            name="run_blender_script",
            description="Ejecuta un script de Blender si Blender está instalado en PATH.",
