...
def build_system_tools() -> list[Tool]:
    return [
        Tool(
            name="open_path",
            description="Abre un archivo o carpeta local con la aplicacion predeterminada.",
            parameters={"path": "Ruta, o nombre conocido como descargas/documentos/escritorio"},
            handler=open_path,
        ),
        Tool(
            name="reveal_path",
            description="Muestra un archivo o carpeta local en el Explorador de Windows.",
            parameters={"path": "Ruta, o nombre conocido como descargas/documentos/escritorio"},
            handler=reveal_path,
        ),
        Tool(
            name="open_app",
            description="Abre una aplicacion del sistema como chrome, vscode, calculadora o bloc de notas.",
