...
10. CONSULTA DE TIEMPO:
Si Miguel pregunta la hora, responde de forma directa, breve y con tu personalidad sarcástica.
...
class BoltApp(ctk.CTk):
    def __init__(self):
        ...
        # --- NUEVO: OBTENER HORA AL INICIAR ---
        hora_actual = datetime.now().strftime("%d/%m/%Y, %H:%M:%S")
        instruccion_dinamica = SYSTEM_INSTRUCTION + f"\n[SISTEMA: La fecha y hora actual para ti es {hora_actual}. Tenla siempre en cuenta.]"
        ...
        # --- EL CEREBRO CON LA HORA INTEGRADA ---
